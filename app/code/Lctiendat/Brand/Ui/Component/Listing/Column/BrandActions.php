 ...
 */
namespace Lctiendat\Brand\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'brands/brand/edit';
    const CMS_URL_PATH_DELETE = 'brands/brand/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['brand_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['brand_id' => $item['brand_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
